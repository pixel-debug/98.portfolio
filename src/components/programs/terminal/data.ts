...
export const FAKE_FILES = [
  { name: "AUTOEXEC.BAT", size: "512", date: "04-23-98" },
  { name: "CONFIG.SYS", size: "256", date: "04-23-98" },
  { name: "COMMAND.COM", size: "93,812", date: "05-11-98" },
  { name: "IO.SYS", size: "222,390", date: "05-11-98" },
  { name: "MSDOS.SYS", size: "2,048", date: "05-11-98" },
  { name: "WIN.COM", size: "27,648", date: "05-11-98" },
  { name: "NOTEPAD.EXE", size: "54,272", date: "05-11-98" },
  { name: "CALC.EXE", size: "102,400", date: "05-11-98" },
  { name: "SECRETS.TXT", size: "69", date: "06-04-98" },
  { name: "DO_NOT_OPEN.EXE", size: "666", date: "06-06-98" },
  { name: "MIKU.TXT", size: "4,096", date: "08-31-04" },
];

export const MIKU_ASCII = `
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⡀⣀⣤⣴⣶⣶⣶⣤⣿⣶⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣆⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣧⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
Ethernet adapter Local Area Connection:
  ...
  DNS Servers . . . . . . . . . . : 8.8.8.8
                                    8.8.4.4
  Lease Obtained. . . . . . . . . : Friday, April 10, 1998 9:00:00 AM
  Lease Expires . . . . . . . . . : Saturday, April 11, 1998 9:00:00 AM
`;
